...
const SignIn = () => {
  ...
  return (
    <div className="container vh-100 d-flex flex-column justify-content-center align-items-center main-container">
      ...
      <div className='fga'>
        <div className='boxes'><img src="/src/assets/jam_facebook.png" alt="" /></div>
        <div className='boxes'><img src="/src/assets/devicon_google.png" alt="" /></div>
        <div className='boxes'><img src="/src/assets/ic_round-apple.png" alt="" /></div>
      </div>
